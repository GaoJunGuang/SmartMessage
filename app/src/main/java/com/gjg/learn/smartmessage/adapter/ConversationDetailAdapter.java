...
import com.gjg.learn.smartmessage.bean.Sms;
import com.gjg.learn.smartmessage.util.Constant;

/**
 * Created by Junguang_Gao on 2016/11/17.
 */
public class ConversationDetailAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
       ...
       // return LayoutInflater.from(context).inflate(R.layout.item_conversation_detail,parent,false);
