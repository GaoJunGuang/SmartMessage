package com.gjg.learn.smartmessage.provider;
...
import com.gjg.learn.smartmessage.dao.GroupOpenHelper;
...
public class GroupProvider extends ContentProvider {
	...
	private static final String authority = "com.gjg.learn.smartmessage";
